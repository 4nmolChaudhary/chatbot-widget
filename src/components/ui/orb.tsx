...
const Orb: React.FC<SiriOrbProps> = ({ size = '192px', className, colors, animationDuration = 20 }) => {
  const defaultColors = {
      ...
      style={
        {
          ...
          boxShadow: `inset 11px 4px 3px 13px rgb(251 251 251), inset -20px 8px 1px 10px rgb(255 255 255), 7px 11px 20px 5px rgb(0 36 255 / 25%)`,
